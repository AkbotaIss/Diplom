...
def test_add_ingredient_adds_ingredient_to_list():
    burger = Burger()
...
def test_remove_ingredient_removes_ingredient_by_index():
    burger = Burger()
    ingredient_1 = Mock()
    ingredient_2 = Mock()
    ingredient_3 = Mock()
...
def test_move_ingredient_changes_ingredients_order():
    burger = Burger()
    ingredient_1 = Mock()
    ingredient_2 = Mock()
    ingredient_3 = Mock()
...
def test_get_price_returns_total_price(bun_price, ingredient_prices, expected_price):
    burger = Burger()
